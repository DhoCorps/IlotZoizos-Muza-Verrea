...
- Name: kanban.lifecycle.spec.ts >> Poste de Pilotage - Module Kanban >> ❌ Le clic sur Fermer rétracte le tiroir
- Location: apps\hub-central\e2e\kanban.lifecycle.spec.ts:35:7
