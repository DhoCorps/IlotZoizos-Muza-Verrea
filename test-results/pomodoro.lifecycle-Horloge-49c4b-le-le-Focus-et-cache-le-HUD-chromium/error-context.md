...
- Name: pomodoro.lifecycle.spec.ts >> Horlogerie Bionique - Module Pomodoro >> ❌ Le clic sur la croix annule le Focus et cache le HUD
- Location: apps\hub-central\e2e\pomodoro.lifecycle.spec.ts:29:7
