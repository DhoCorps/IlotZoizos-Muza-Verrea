...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      console.error("🔥 [SESSION ERROR ABYSS UPLOAD]", sessionErr);
    ...
    try {
      ...
      console.error("🔥 [PARAMS ERROR ABYSS UPLOAD]", paramsErr);
...
export async function DELETE(
  ...
  try {
    ...
    try {
      ...
      console.error("🔥 [SESSION ERROR ABYSS DELETE]", sessionErr);
      return NextResponse.json({ error: 'Erreur de session.' }, { status: 500 });
    }
    ...
    try {
      ...
      console.error("🔥 [PARAMS ERROR ABYSS DELETE]", paramsErr);
      return NextResponse.json({ error: 'Paramètre de slug illisible.' }, { status: 400 });
    }
