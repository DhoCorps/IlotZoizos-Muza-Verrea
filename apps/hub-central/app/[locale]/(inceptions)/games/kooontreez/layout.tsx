...
export const metadata = {
  title: 'KoOonTreeZ | Îlot Zoizos',
  description: 'L’exploration géographique et la reconnaissance des drapeaux en temps réel.',
};

export default function KoOonTreeZLayout({
  children,
}: {
