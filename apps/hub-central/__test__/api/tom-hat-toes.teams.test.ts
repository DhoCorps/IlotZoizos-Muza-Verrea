...
import { GET, POST } from '@/app/api/tom-hat-toes/teams/route';
...
// 🧪 SUITE DE TESTS
// -------------------------------------------------------------------------
describe('Route API : Nids / Escouades (GET / POST /api/tom-hat-toes/teams)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe('GET - Recensement des Nids (Neo4j + Mongo)', () => {
    it('doit rejeter (401) si l\'utilisateur n\'a pas d\'Aura', async () => {
      ...
      const req = new NextRequest('http://localhost/api/tom-hat-toes/teams');
