...
import { POST } from '@/app/api/tom-hat-toes/tasks/[slug]/pomodoro/route';
...
describe('Route API : Pomodoro (POST /api/tom-hat-toes/tasks/[slug]/pomodoro)', () => {
  ...
  it('doit rejeter (401) si l\'utilisateur n\'est pas connecté', async () => {
    const req = new NextRequest('http://localhost/api/tom-hat-toes/tasks/my-task/pomodoro', { method: 'POST' });
  ...
  it('doit renvoyer 404 si l\'atome est introuvable', async () => {
    ...
    const req = new NextRequest('http://localhost/api/tom-hat-toes/tasks/inconnue/pomodoro', { method: 'POST' });
  ...
  it('doit valider le cycle Pomodoro avec succès (200) et invalider le cache', async () => {
    ...
    const req = new NextRequest('http://localhost/api/tom-hat-toes/tasks/ma-tache/pomodoro', { method: 'POST' });
