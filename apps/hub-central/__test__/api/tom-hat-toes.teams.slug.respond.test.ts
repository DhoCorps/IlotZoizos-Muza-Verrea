...
import { POST } from '@/app/api/tom-hat-toes/teams/[slug]/respond/route';
...
// 🧪 SUITE DE TESTS
// -------------------------------------------------------------------------
describe('Route API : Réponse au Pacte d\'Adhésion (POST /api/tom-hat-toes/teams/[slug]/respond)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('doit rejeter (401) si l\'utilisateur n\'a pas d\'Aura', async () => {
    ...
    const req = new NextRequest('http://localhost/api/tom-hat-toes/teams/mon-nid/respond', {
      method: 'POST',
