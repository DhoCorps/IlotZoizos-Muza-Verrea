...
import { POST } from '@/app/api/tom-hat-toes/teams/[slug]/members/route';
...
// 🧪 SUITE DE TESTS
// -------------------------------------------------------------------------
describe('Route API : Membres et Recrutement (POST /api/tom-hat-toes/teams/[slug]/members)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('doit rejeter (401) si l\'utilisateur n\'a pas d\'Aura', async () => {
    ...
    const req = new NextRequest('http://localhost/api/tom-hat-toes/teams/mon-nid/members', {
      method: 'POST',
