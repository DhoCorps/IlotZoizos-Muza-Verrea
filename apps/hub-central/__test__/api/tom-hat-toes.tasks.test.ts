...
import { GET, POST } from '@/app/api/tom-hat-toes/tasks/route';
...
describe('Route API : Atomes (Tasks) /api/tom-hat-toes/tasks', () => {
    ...
    it('🟢 GET : doit renvoyer les tâches avec succès', async () => {
        ...
        const req = new NextRequest('http://localhost:3000/api/tom-hat-toes/tasks');
