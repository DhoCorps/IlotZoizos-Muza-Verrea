...
export function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex justify-end bg-black/80 backdrop-blur-md animate-in fade-in"
      role="dialog"
      aria-modal="true"
      aria-label="Panier de l'Îlot"
    >
      <div className="w-full max-w-md bg-[#0A0D14] border-l border-white/10 h-full flex flex-col justify-between p-6 md:p-8 shadow-2xl relative animate-in slide-in-from-right duration-300">
        ...
        <div className="space-y-4 pt-4 border-t border-white/5">
          ...
          <button
            ...
            aria-label="Sceller la Commande"
