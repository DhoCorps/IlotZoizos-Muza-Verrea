// apps/hub-central/components/kontakt/cv-editor/CVSidebarPanel.tsx
'use client';
...
export function CVSidebarPanel({
  selectedBlock,
  registry,
  onUpdateData,
  onClose
    ...
    return (
      <div className="p-8 bg-black/40 border border-white/5 rounded-3xl backdrop-blur-xl text-center space-y-4">
        ...
        <div className="space-y-1">
          <h3 className="text-sm font-black uppercase text-white tracking-widest">Panneau Synaptique</h3>
          <p className="text-xs font-mono text-slate-400">
            Sélectionne un bloc sur le canevas pour configurer ses paramètres internes.
          </p>
        </div>
      </div>
    );
